...
import { LogIn, Mail, Lock, Eye, EyeOff, Truck, CheckCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#0D0D0D] flex">
      ...
      <div className="hidden lg:flex flex-col justify-between flex-1 bg-[#171717] border-r border-white/8 p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-8">
          <div>
            <h2 className="text-4xl font-black text-[#F4E9D8] leading-tight mb-3">
              Vendor<br />
              <span className="text-[#FE5E00]">Operations Portal</span>
            </h2>
        ...
        <div className="relative z-10 flex gap-8 pt-8 border-t border-white/8">
          {[["12", "Active Orders"], ["98%", "On-time Rate"], ["₹8.2L", "This Month"]].map(([val, lbl]) => (
            <div key={lbl}>
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <a href="#" className="text-xs text-[#FE5E00] hover:text-[#E05200] transition-colors">Forgot?</a>
              </div>
              <div className="relative">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <label htmlFor="rm" className="text-sm text-[#D4C4A8]/70 cursor-pointer">Remember me</label>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-[#D4C4A8]/50">
              Need help?{" "}
              <a href="#" className="text-[#FE5E00] hover:text-[#E05200] font-semibold transition-colors">Contact Support</a>
            </p>
          </div>

          <p className="text-center text-xs text-[#D4C4A8]/25 mt-6">
