...
const heroTitleClass =
  "font-bold tracking-tight text-white [text-shadow:0_1px_2px_rgba(0,0,0,0.9),0_4px_28px_rgba(0,0,0,0.65)]";
...
function GlassStat({
  ...
  return (
    <div
      className={cn(
        glassPanel,
        "px-4 py-3.5 transition-all duration-300 hover:-translate-y-0.5 hover:border-[#E85A00]/25 hover:shadow-[0_16px_48px_rgba(0,0,0,0.5),inset_0_1px_0_0_rgba(255,255,255,0.22)]",
        className
      )}
      style={style}
    >
      <p className="text-lg font-bold tracking-tight text-white">{value}</p>
      <p className="text-[11px] font-medium uppercase tracking-wider text-white/65">{label}</p>
    </div>
  );
}
...
function LoginVisual() {
  return (
    <div className="relative flex h-full min-h-0 w-full flex-1 flex-col justify-center px-6 py-10 md:px-10 lg:px-14">
      <div
        className="pointer-events-none absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-[#E85A00]/20 via-[#E85A00]/06 to-transparent"
        aria-hidden
      />
      ...
      <header className="space-y-4 animate-fade-up">
        <p className="inline-flex w-fit items-center rounded-full border border-[#E85A00]/35 bg-[#E85A00]/15 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.2em] text-white/90">
          B2B Marketplace
        </p>
        ...
        <p className="max-w-lg text-sm leading-relaxed text-white/85 md:text-base">
          Manage projects, RFQs, procurement, vendors, orders and construction materials from one platform.
        </p>
        <div className="h-1 w-14 rounded-full bg-[#E85A00] shadow-[0_0_20px_rgba(232, 90, 0,0.55)]" />
      </header>
      ...
      <ul className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-3.5">
        {LOGIN_FEATURES.map(({ label, icon: Icon }, i) => (
          <li
            ...
            className={cn(
              glassPanel,
              "flex items-center gap-3 px-3.5 py-2.5 text-sm font-medium text-white transition-all duration-300 hover:border-[#E85A00]/30 animate-fade-up"
            )}
            style={{ animationDelay: `${80 + i * 50}ms` }}
          >
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[#E85A00] text-white shadow-[0_4px_16px_rgba(232, 90, 0,0.45)] ring-1 ring-white/20">
              <Icon className="h-4 w-4" strokeWidth={2} aria-hidden />
            </span>
            <span className="flex min-w-0 flex-1 items-center gap-2">
              <Check className="h-3.5 w-3.5 shrink-0 text-[#E85A00]" strokeWidth={2.5} aria-hidden />
...
function RegisterVisual() {
  return (
    <div className="relative flex h-full min-h-0 w-full flex-1 flex-col justify-center px-6 py-10 md:px-10 lg:px-14">
      <div
        className="pointer-events-none absolute inset-x-0 bottom-0 h-44 bg-gradient-to-t from-[#E85A00]/28 via-[#111]/40 to-transparent"
        aria-hidden
      />
      <div className="pointer-events-none absolute inset-x-0 top-1/4 h-px max-w-md bg-gradient-to-r from-transparent via-[#E85A00]/40 to-transparent opacity-80 md:max-w-lg" aria-hidden />
      ...
      <div className="relative z-[1] mx-auto flex w-full max-w-xl flex-col gap-11 pt-2 md:gap-12 lg:max-w-2xl lg:gap-14">
        <header className="space-y-5 animate-fade-up">
          <p className="inline-flex w-fit items-center rounded-full border border-[#E85A00]/35 bg-[#E85A00]/12 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.2em] text-[#EFE4CC]">
            Join StructBay
          </p>
          ...
          <p className="max-w-lg text-base leading-relaxed text-white/90 md:text-lg md:leading-relaxed">
            Join India&apos;s growing B2B construction ecosystem.
          </p>
          <div className="flex items-center gap-3">
            <div className="h-1 w-16 rounded-full bg-[#E85A00] shadow-[0_0_24px_rgba(232, 90, 0,0.6)]" />
            <span className="text-xs font-semibold uppercase tracking-wider text-white/50">Procurement · Vendors · Projects</span>
          </div>
        </header>
        ...
        <div className="grid grid-cols-1 gap-3.5 sm:grid-cols-2 sm:gap-4">
          {REGISTER_FLOAT.map(({ label, icon: Icon }, i) => (
            <div
              ...
              className={cn(
                glassPanel,
                "group flex items-center gap-3.5 px-4 py-3.5 transition-all duration-300 hover:-translate-y-1 hover:border-[#E85A00]/35 animate-fade-up"
              )}
              style={{ animationDelay: `${70 + i * 55}ms` }}
            >
              <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#E85A00] text-white shadow-[0_6px_20px_rgba(232, 90, 0,0.5)] ring-2 ring-[#E85A00]/35 transition-transform duration-300 group-hover:scale-105">
                <Icon className="h-[19px] w-[19px]" strokeWidth={1.85} aria-hidden />
              </span>
              <span className="min-w-0 text-sm font-semibold leading-snug text-white sm:text-[0.9375rem]">{label}</span>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-black">
      ...
      >
        ...
        <div
          className="absolute inset-0 bg-gradient-to-br from-black/90 via-black/65 to-[#E85A00]/28"
          aria-hidden
        />
        <div
          className="absolute inset-0 bg-[radial-gradient(ellipse_90%_60%_at_70%_100%,rgba(232, 90, 0,0.22),transparent_55%)]"
          aria-hidden
        />
      ...
      <section
        className={cn(
          ...
          "bg-white px-5 py-10 sm:px-8 lg:px-10 lg:py-12"
        )}
      >
        <div
          className={cn(
            "w-full max-w-[500px] rounded-2xl border border-gray-200 bg-white p-8 shadow-[0_16px_40px_rgba(0,0,0,0.08)]",
            "transition-shadow duration-300 hover:shadow-[0_20px_48px_rgba(0,0,0,0.1)]",
            "animate-fade-up"
          )}
        >
